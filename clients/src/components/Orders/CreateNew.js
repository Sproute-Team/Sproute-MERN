...
function CreateNew() {
  return (
    <div className='bg-white pl-5 mt-5 w-80 m-auto'>
    <span className='pt-5 font-bold'>Create</span>
    <div className='flex justify-between text-[12px] pr-5'>
        <span>Today</span>
        <span className="text-[#FA4B0C] font-bold">View All</span>
    </div>
    <p className="text-[rgba(0,0,0,0.4)] text-[12px] font-bold ">Create New</p>
