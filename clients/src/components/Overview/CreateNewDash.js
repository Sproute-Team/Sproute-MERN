...
function CreateNewDash() {
  return (
    ...
    <svg width="17" height="18" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.5 27C20.4432 27 26 21.1392 26 14C26 6.86084 20.4432 1 13.5 1C6.55676 1 1 6.86084 1 14C1 21.1392 6.55676 27 13.5 27Z" stroke="black" stroke-opacity="0.5" strokeWidth="2"/></svg>
